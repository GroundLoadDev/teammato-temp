...
const privacySections: LegalSection[] = [
  ...
  },
  {
    ...
    content: [
      "Plaintext Never Stored. We process user submissions and persist them as ciphertext only. No plaintext message content is stored in databases or logs.",
      "Strong Encryption at Rest. Workspace Data is encrypted at rest using per-organization 256-bit data encryption keys (DEKs) with XChaCha20-Poly1305 AEAD and unique nonces per record. DEKs are generated locally, stored wrapped, and support rotation.",
      "K-Anonymity Default. All views/exports/digests are k-gated with k=5 (no small-n exposure). Small cohorts are hidden by default across UI/exports.",
      "PII Filtering at Ingestion. Mentions, emails, phone numbers, and Slack IDs are scrubbed before encryption.",
      "Content-Free Analytics. We maintain an append-only, content-free event stream and aggregated counts only; no message text is logged.",
